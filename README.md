...
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/plunarx7/sshvpn/main/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>
or ( ipv4 + ipv6 )
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/plunarx7/sshvpn/main/setup2.sh && chmod +x setup2.sh && screen -S install ./setup2.sh</code></pre>


Update Menu
<pre><code>wget -q -O /usr/sbin/updatemenu "https://raw.githubusercontent.com/plunarx7/sshvpn/main/update/updatemenu.sh" && chmod +x /usr/sbin/updatemenu && updatemenu</code></pre>
